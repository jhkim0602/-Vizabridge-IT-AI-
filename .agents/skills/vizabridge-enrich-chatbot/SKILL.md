...
2. **Load progress**. Run
   `python .Codex/skills/vizabridge-enrich-chatbot/scripts/show_progress.py {manual_key}`.
...
5. **Append**. Write the candidate block to `/tmp/vizabridge_chatbot_block.md`
   and run
   `python .Codex/skills/vizabridge-enrich-chatbot/scripts/append_block.py {manual_key} {record_id} /tmp/vizabridge_chatbot_block.md`.
